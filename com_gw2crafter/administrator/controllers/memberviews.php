 ...
 * @since  1.6
 */
class Gw2crafterControllerMemberviews extends JControllerAdmin
{
	/**
	 * Method to clone existing Memberviews
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'memberview', $prefix = 'Gw2crafterModel', $config = array())
	{
