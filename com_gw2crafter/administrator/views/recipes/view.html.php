 ...
 * @since  1.6
 */
class Gw2crafterViewRecipes extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GW2CRAFTER_TITLE_RECIPES'), 'items.png');
		JToolBarHelper::custom('recipes.updateapi', 'updateapi.png', 'updateapi_f2.png', 'Update Api', false);
		...
		JHtmlSidebar::setAction('index.php?option=com_gw2crafter&view=recipes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`gw2_recipe_type`' => JText::_('COM_GW2CRAFTER_RECIPES_GW2_RECIPE_TYPE'),
			'a.`gw2_recipe_name`' => JText::_('COM_GW2CRAFTER_RECIPES_GW2_RECIPE_NAME'),
		);
	}
