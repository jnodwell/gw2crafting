...
<div class="item_container" id="item_container">
	...
	<div class="item_prices" id="item_prices">
		<table class="item_prices">
			...
			<tr>
				<td colspan="2" class="center"><?php echo JText::_('Volume'); ?> : <?php echo $price_data[0]['total_buys']; ?>
				...
				<td colspan="2" class="center"><?php echo JText::_('Volume'); ?> : <?php echo $price_data[1]['total_sells']; ?>
			...
			<tr>
				<td colspan="4" class="center">B:S = <?php echo number_format($buy/$sell,4);?>&nbsp;&nbsp;C:B = <?php echo number_format($buy/$cost,4);?>&nbsp;&nbsp;P:L = <?php echo number_format($sell/($sell-$sell*.05-$sell*.1-$cost),4);?>%</td>
			...
			<tr>
				...
				<td><?php echo Gw2crafterHelpersGw2crafter::getPriceFormatted($buy-$buy*.05-$buy*.1-$cost); ?></td>
				<td><?php echo JText::_('List'); ?></td>
				<td><?php echo Gw2crafterHelpersGw2crafter::getPriceFormatted($sell-$sell*.05-$sell*.1-$cost); ?></td>
			</tr>
		</table>
	</div>
</div>
